...
WebUI.click(findTestObject('Object Repository/Page_Pesanan  Resellerindo/div_2.Layanan Test Developer Dripfill      _e39054'))

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Ambil foto dari instagram_target'), 'sjdlhfhfaf')

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Jumlah Hari_value'), '3')

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Jumlah Pesanan_qty'), '5')

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Jumlah Hari_value'), '10')
