...
WebUI.click(findTestObject('Object Repository/Page_Pesanan  Resellerindo/div_8.Layanan Test Developer subscription  _c693fb'))

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Ambil foto dari instagram_target'), 'jfhwejiw')

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Jumlah Like  View Per Post_value'), '50')

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Jumlah Post_value'), '2')

//WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Pesanan  Resellerindo/select_Pilih Waktu Jeda0510306090'), 
//    '0', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Pesanan  Resellerindo/select_Pilih Waktu Jeda0510306090'), 
    '5', true)

WebUI.click(findTestObject('Object Repository/Page_Pesanan  Resellerindo/div_perm_identityInformasi PentingSpesifika_72eff9'))
