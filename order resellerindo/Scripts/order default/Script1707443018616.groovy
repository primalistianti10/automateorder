...
WebUI.click(findTestObject('Object Repository/Page_Pesanan  Resellerindo/div_1. FLASH SALE Instagram Foll Indo MIX 1_e928ae'))

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Ambil foto dari instagram_target'), 'sgegtewtwtwnbgfsdfjsd')

WebUI.setText(findTestObject('Object Repository/Page_Pesanan  Resellerindo/input_Jumlah Pesanan_qty'), '500')
